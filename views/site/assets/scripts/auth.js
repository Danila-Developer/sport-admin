...
function makeLoginModalButtonActive() {
   if (document.querySelector('.header__nav__ul__user__span_login') == null) return
   document.querySelectorAll('.header__nav__ul__user__span_login').forEach(btn => {
      btn.addEventListener('click', e => {
         ...
         <div class="login-block">
            <div class="login_close">
               <svg fill="white" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
         ...
         modal.querySelector('.login_close').onclick = () => {
...
function makeRegistrationModalButtonActive() {
   if (document.querySelector('.header__nav__ul__user__span_registration') == null) return
   document.querySelectorAll('.header__nav__ul__user__span_registration').forEach(btn => {
      btn.addEventListener('click', e => {
         const modal = document.createElement('div')
